...
-(instancetype)initWithFrame:(CGRect)frame numberOfStars:(NSInteger)numberOfStars currentScore:(CGFloat)currentScore rateStyle:(RateStyle)rateStyle isInteractive:(BOOL)isInteractive  finish:(finishBlock)finish{
    if (self = [super initWithFrame:frame]) {
        _numberOfStars = numberOfStars;
        _rateStyle = rateStyle;
        ...
        [self createStarView:isInteractive];
    }
    return self;
}

#pragma mark - private Method
-(void)createStarView:(BOOL)isInteractive{
